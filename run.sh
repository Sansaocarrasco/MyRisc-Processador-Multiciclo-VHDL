...
vlib work && vcom '-2019' '-o' control.vhd rreg32.vhd rom.vhd ram.vhd registers.vhd alucontrol.vhd alu.vhd memoryAcess.vhd mux232.vhd ir.vhd mux432.vhd reg2.vhd mux332.vhd mux25.vhd fetch.vhd decoder.vhd execute.vhd design.vhd testbench.vhd  && vsim -c -do "vsim testbench; run -all; exit"  ; echo 'Creating result.zip...' && zip -r /tmp/tmp_zip_file_123play.zip . && mv /tmp/tmp_zip_file_123play.zip result.zip